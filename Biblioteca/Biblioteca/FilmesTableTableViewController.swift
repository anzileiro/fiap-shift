...
class FilmesTableTableViewController: UITableViewController {
    ...
    private var filmes = ["2012", "Avatar", "THOR", "Anjos da Noite"]
    private var imagens = ["filme1", "filme2", "filme3", "filme4"]
    ...
    @IBAction func visualizarFilme(sender: AnyObject){
        self.performSegueWithIdentifier("filmeParaDetalheSegue", sender: sender)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if let i = sender?.tag {
            vc.nomeFilmeText = filmes[i]
            vc.nomeImagem = imagens[i]
        }
